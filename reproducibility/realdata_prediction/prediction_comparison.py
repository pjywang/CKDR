...
def codalasso_clf(counts, y, test_size=.2, cvfolds=5, lamseq=np.geomspace(0.001, 1, 30), reps=100, verbose=False, njobs=False, seed=MASTER_SEED):
    ...
    """
    # This may help ensure R environment is set up. Comment out if needed.
    setup_r_environment() 
