...
from reproducibility.realdata_prediction.prediction_comparison import clr_rf_clf, clr_rf_reg
...
def main():
    ...
    ileum_result = {
        ...
        "method": "clr-RF",
        "metric": "accuracy",
        "values": clr_rf_clf(x_ileum, y_ileum, reps=100, seed=MASTER_SEED),
        "seed": MASTER_SEED,
    }
    with (outdir / "ileum_clr-RF.pkl").open("wb") as f:
    ...
    vaginal_result = {
        ...
        "method": "clr-RF",
        "metric": "mse",
        "values": clr_rf_reg(x_vaginal, y_vaginal, reps=100, seed=MASTER_SEED),
        "seed": MASTER_SEED,
    }
    with (outdir / "vaginal_clr-RF.pkl").open("wb") as f:
